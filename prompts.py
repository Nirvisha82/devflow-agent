...
Step 2: Use file_read to examine 2-3 key files related to the issue
Step 3: Identify all files that need to be touched
Step 4: Make the necessary changes using file_write or editor tools
...
TOOL USAGE STRATEGY:
1. file_read: Read 2-3 key files to understand the code (max 3 reads)
2. file_write or editor: Make your changes (3-5 modifications)
...
- Use editor for small changes, file_write for new files or rewrites
